 ...
 */
public class ProcessAnotherCampCommanderRequestJPanel extends javax.swing.JPanel {

    JPanel userProcessContainer;
    NewRequestFromCampCommandantToCampCommandant request;

    /**
     * Creates new form ProcessWorkRequestJPanel
     */
    public ProcessAnotherCampCommanderRequestJPanel(JPanel userProcessContainer, NewRequestFromCampCommandantToCampCommandant request) {
        try {
            initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.add(resultComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 20, -1, -1));
        ...
        jPanel2.add(justificationTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 110, 240, 101));
        ...
        jPanel2.add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 20, -1, -1));
        ...
        jPanel2.add(submitJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 230, -1, -1));
        jPanel2.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 370, 20));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 140, 390, 290));
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        try {
            ...
            Component component = componentArray[componentArray.length - 1];
            CampCommandantWorkAreaJPanel dwjp = (CampCommandantWorkAreaJPanel) component;
            dwjp.populateCampCommandantTable();
            CardLayout layout = (CardLayout) userProcessContainer.getLayout();
            layout.previous(userProcessContainer);
        } catch (NullPointerException ex) {
            JOptionPane.showMessageDialog(null, "Null Pointer Exception Occurred!");
